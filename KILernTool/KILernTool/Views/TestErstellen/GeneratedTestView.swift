...
struct GeneratedTestView: View {
    ...
    // MARK: - Max Preview Banner

    private var maxPreviewBanner: some View {
        HStack(spacing: 14) {
            MascotView(color: accent, mood: .happy, size: 58)
            ...
            VStack(alignment: .leading, spacing: 5) {
                ...
                Text("Voilà! 🎉 Dein Test mit \(test.allAufgaben.count) Aufgaben ist fertig!\nBereit zum Ausdrucken oder Exportieren?")
                    .font(.system(size: 14))
